...
async def _sign_in(user: str, passwd: str, user_server: str, app_id: str, app_secret: str,
  ...
  logging.debug('POST {}, body={}, headers={}'.format(url, json.dumps(query), headers))
...
async def _get_device_properties(devices_server: str, dsn: str, headers: dict, session: aiohttp.ClientSession, ssl_context: ssl.SSLContext):
